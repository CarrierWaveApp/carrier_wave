...
enum WWFFRepresentativeDirectory {
    ...
    static func representative(forDXCC dxcc: Int) -> WWFFRepresentative? {
        guard let code = dxccToProgramCode[dxcc] else { return nil }
    ...
    static func mailtoURL(
        ...
        guard let email = representative.email else { return nil }
    ...
    /// Static directory of WWFF national program representatives.
    ...
    private static let representatives: [WWFFRepresentative] = [
        WWFFRepresentative(
    ...
    private static let dxccToProgramCode: [Int: String] = [
        1: "VEFF", // Canada
