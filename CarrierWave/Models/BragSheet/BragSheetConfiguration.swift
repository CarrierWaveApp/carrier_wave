...
nonisolated struct BragSheetPeriodConfig: Codable, Equatable, Sendable {
    // MARK: Lifecycle
    ...
    mutating func toggleHero(_ stat: BragSheetStatType) -> Bool {
        guard enabledStats.contains(stat) else {
            return false
        }
...
nonisolated struct BragSheetConfiguration: Codable, Equatable, Sendable {
    // MARK: Lifecycle
...
nonisolated extension BragSheetConfiguration {
