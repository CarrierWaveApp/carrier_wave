...
public enum AntennaPattern: Sendable, Equatable {
    ...
    public static func defaultPattern(
        ...
        switch antennaType {
        case .vertical, .whip, .loop:
            return .omnidirectional
        case .dipole, .endFed, .longwire, .beverage:
            return .figureEight(orientation: orientationDeg)
        case .yagi:
            return .cardioid(heading: orientationDeg, beamwidthDeg: 60)
        case .logPeriodic:
            return .cardioid(heading: orientationDeg, beamwidthDeg: 70)
        case .hexBeam:
            return .cardioid(heading: orientationDeg, beamwidthDeg: 80)
        case .unknown:
            return .omnidirectional
        }
    }
