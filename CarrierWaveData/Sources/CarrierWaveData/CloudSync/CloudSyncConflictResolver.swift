...
public enum CloudSyncConflictResolver {
    ...
    nonisolated public static func mergeQSO(
        local: QSOFields,
        remote: QSOFields,
        localModDate: Date,
        remoteModDate: Date
    ...
    nonisolated public static func mergeServicePresence(
    ...
    nonisolated public static func mergeLoggingSession(
        ...
        return LoggingSessionFields(
            ...
            qsoCount: max(local.qsoCount, remote.qsoCount),
    ...
    nonisolated public static func mergeActivationMetadata(
    ...
    nonisolated public static func mergeSessionSpot(
    ...
    nonisolated public static func mergeActivityLog(
